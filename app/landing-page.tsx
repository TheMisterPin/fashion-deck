          ...
          <div className="overflow-hidden transition-transform duration-300 transform shadow-2xl bg-stone-50 rounded-2xl hover:scale-105">
            ...
            <div className="flex items-center justify-between px-8 py-4 bg-stone-800">
              <div className="flex space-x-4">
                <span className="transition-colors duration-200 cursor-pointer text-stone-300 hover:text-white">Features</span>
                <span className="transition-colors duration-200 cursor-pointer text-stone-300 hover:text-white">Pricing</span>
                <span className="transition-colors duration-200 cursor-pointer text-stone-300 hover:text-white">About</span>
              </div>
