...
import { PreTrainedModel, Processor } from "@xenova/transformers";
...
export default function UploadForm() {
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        processorRef.current = await AutoProcessor.from_pretrained(model_id) as Processor;
      } catch (err) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      formData.append("key", process.env.NEXT_PUBLIC_IMGBB_API_KEY!); // Replace with your API key
